...
const BlogPost = () => {
    ...
    // SEO data
    const siteUrl = 'https://demovement.es';
    const canonicalUrl = `${siteUrl}/blog/${slug}`;
    const metaTitle = `${post.title} | DeMovement Blog`;
    const metaDescription = post.seo?.description || `${post.intro.substring(0, 150)}...`;
    const metaKeywords = post.seo?.lsi?.join(', ') || '';
    const metaImage = `${siteUrl}${post.image}`;
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="keywords" content={`${post.seo?.keyword || ''}, ${metaKeywords}`} />
                <meta name="author" content={post.author || 'DeMovement'} />
                ...
                <meta property="og:site_name" content="DeMovement" />
                <meta property="article:published_time" content={post.date} />
                <meta property="article:author" content={post.author || 'DeMovement'} />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "publisher": {
                            ...
                            "logo": {
                                "@type": "ImageObject",
                                "url": `${siteUrl}/imagenes/logos/header-logo.svg`
                            }
                        },
